...
public class TranslatorApi {
    ...
    public static void main(String[] args) {
        System.out.println(TranslatorApi.translateEnToVi("Hello Hoang, I'm Nhat. How are you?"));
        System.out.println(TranslatorApi.translateViToEn("chào bạn, bạn khỏe không?, lâu không gặp"));
